...
static void create_player_task(void) {
  ...
  xTaskCreateStatic(player_task, "Player Task", ARRAY_SIZE(player_task_stack), NULL, PRIORITY_LOW, player_task_stack,
                    &player_task_struct);
}

static void create_reader_task(void) {

  xTaskCreate(reader_task, "Reader Task", (512U * 8) / sizeof(void *), NULL, PRIORITY_LOW, NULL);
